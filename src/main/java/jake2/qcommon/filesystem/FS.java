    ...
    private static String autodetectBasedir() {
        ...
        if (home != null && !home.isBlank()) {
            ...
            if (steamLinuxPath.exists()) {
                LOGGER.info("Auto-detected steam q2 installation at :" + steamLinuxPath);
            ...
            if (macSteamPath.exists()) {
                LOGGER.info("Auto-detected steam q2 installation at :" + macSteamPath);
        ...
        if (windowsProgramFiles.exists()) {
            LOGGER.info("Auto-detected steam q2 installation at :" + windowsProgramFiles);
        ...
        if (windowsProgramFiles64.exists()) {
            LOGGER.info("Auto-detected steam q2 installation at :" + windowsProgramFiles64);
