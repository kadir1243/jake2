...
public final class V extends Globals {
     ...
     * ============= V_Viewpos_f =============
     */
    private static Command Viewpos_f = args -> Com.print("(%i %i %i) : %i\n", (int) ClientGlobals.cl.refdef.vieworg[0], (int) ClientGlobals.cl.refdef.vieworg[1]
            , (int) ClientGlobals.cl.refdef.vieworg[2], (int) ClientGlobals.cl.refdef.viewangles[YAW]);
