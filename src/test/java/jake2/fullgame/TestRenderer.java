...
public class TestRenderer {
    ...
    void updateScreen() {
        ...
        for (int i = 0; i < text.length(); i++) {
            re.DrawChar(10 + 8 * i, viddef.getHeight() / 2, text.charAt(i));
        }
    ...
    private LinkedList<cparticle_t> active_particles = new LinkedList<>();
    ...
    private void animateParticles() {
        ...
        Iterator<cparticle_t> it = active_particles.iterator();
        while (it.hasNext()) {
            p = it.next();
